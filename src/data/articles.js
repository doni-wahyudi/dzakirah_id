export const articles = [
  {
    id: 1,
    slug: 'mengenal-diri-langkah-pertama-menuju-pulih',
    title: 'Mengenal Diri: Langkah Pertama Menuju Pulih',
    excerpt: 'Perjalanan pemulihan dimulai dari satu langkah sederhana: mengenal siapa diri kita sebenarnya. Dalam Islam, muhasabah adalah kunci untuk menemukan kedamaian...',
    content: `Perjalanan pemulihan dimulai dari satu langkah sederhana: mengenal siapa diri kita sebenarnya. Dalam Islam, muhasabah adalah kunci untuk menemukan kedamaian.
...
Ingat, perjalanan ini bukanlah sprint melainkan marathon. Bersabarlah dengan diri sendiri, karena setiap langkah kecil adalah kemajuan yang bermakna.`,
  ...
  {
    id: 2,
    slug: 'adab-taaruf-dalam-islam',
    title: 'Adab Taaruf dalam Islam: Panduan Lengkap',
    excerpt: 'Taaruf yang syar\'i bukan berarti kaku dan tanpa rasa. Mari belajar bagaimana Islam mengatur proses mengenal calon pasangan dengan indah...',
    content: `Taaruf yang syar'i bukan berarti kaku dan tanpa rasa. Islam mengatur proses mengenal calon pasangan dengan cara yang penuh hikmah dan keindahan.
...
Semoga Allah memudahkan jalan setiap muslimah menuju pernikahan yang penuh keberkahan.`,
  ...
  {
    id: 3,
    slug: 'gentle-parenting-perspektif-islami',
    title: 'Gentle Parenting dari Perspektif Islami',
    excerpt: 'Bagaimana Rasulullah SAW memperlakukan anak-anak? Ternyata beliau adalah teladan sempurna gentle parenting jauh sebelum istilah ini populer...',
    content: `Rasulullah SAW adalah teladan sempurna dalam mendidik anak. Beliau mencontohkan gentle parenting jauh sebelum istilah ini populer di kalangan psikolog modern.
...
Menjadi orang tua yang lembut bukan berarti lemah. Justru dibutuhkan kekuatan besar untuk konsisten dalam kelembutan.`,
  ...
  {
    id: 4,
    slug: 'self-care-untuk-muslimah',
    title: 'Self-Care untuk Muslimah: Bukan Egois, Tapi Kebutuhan',
    excerpt: 'Banyak muslimah merasa bersalah ketika meluangkan waktu untuk diri sendiri. Padahal, self-care adalah bagian dari menjaga amanah Allah...',
    content: `Banyak muslimah merasa bersalah ketika meluangkan waktu untuk diri sendiri. Padahal, merawat diri adalah bagian dari menjaga amanah yang Allah berikan.
...
Ingat, kamu tidak bisa menuangkan dari gelas yang kosong. Isi dulu gelas dirimu agar bisa memberi kepada orang lain.`,
  ...
  {
    id: 5,
    slug: 'manajemen-keuangan-rumah-tangga',
    title: 'Manajemen Keuangan Rumah Tangga Islami',
    excerpt: 'Uang adalah salah satu sumber konflik terbesar dalam rumah tangga. Pelajari bagaimana Islam mengatur keuangan keluarga dengan bijak...',
    content: `Manajemen keuangan yang baik adalah salah satu fondasi rumah tangga yang sakinah. Islam memberikan panduan yang lengkap tentang bagaimana mengatur harta dengan bijak dan penuh keberkahan.
...
Semoga setiap keluarga muslimah bisa mengelola keuangan dengan penuh keberkahan dan ridha Allah SWT.`,
  ...
  {
    id: 6,
    slug: 'mendampingi-anak-tantrum',
    title: 'Cara Mendampingi Anak Tantrum dengan Sabar',
    excerpt: 'Tantrum adalah bagian normal dari tumbuh kembang anak. Yang membedakan adalah bagaimana kita sebagai orang tua meresponnya...',
    content: `Tantrum adalah ekspresi emosi yang wajar pada anak, terutama di usia 1-3 tahun. Yang penting bukan menghentikan tantrum, tapi bagaimana kita mendampinginya dengan penuh kesabaran.
